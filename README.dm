...
Come back at the end of each module, for a sample solution to the coding problems.

Module 2 | Random Networks
Required Packages: Numpy, Random, PyVis 
Goals: In this module you will learn how to generate, visualize, and calculate the clustering coefficient of a random network.
